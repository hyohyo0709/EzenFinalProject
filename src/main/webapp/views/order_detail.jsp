...
<form name="order" method="get"  action="/order_detail">
    <div class="row g-5">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              ...
              <small class="text-muted" name="book_title">{book_title}</small>
            </div>
            <span class="text-muted" name="book_price">{book_price} </span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">상품 이미지 </h6>
              <small class="text-muted" name ="book_img">{book_img}</small>
            </div>
...
<!--         <form class="card p-2">
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <div class="col-5">
              ...
              <input type="id" class="form-control" id="member_id" name="member_id" placeholder="{member_id}">
