...
<table id='ordertable' class="table table-hover border border-primary" >
  <thead>
    <tr >
  ...
  <c:forEach items="${aList}" var="dto">
  	<c:url var="path" value="mypage/orderdetail.do">
		<c:param name="onum" value="${dto.order_number}" />
		<c:param name="mnum" value="${dto.member_number}" />
	</c:url>
