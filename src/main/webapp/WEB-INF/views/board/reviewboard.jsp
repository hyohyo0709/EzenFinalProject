...
<hr />
	...
	<a href="/board/${path}&&board_type=1" >${dto.subject}</a>
	</td>
	...
	<li class="page-item"><a class="page-link" href="reviewboard.do?currentPage=${pv.startPage-pv.blockPage}">Previous</a></li>
	</c:if>
	...
	<!-- 이전 출력 시작 -->
	 ...
	 <c:forEach var="i" begin="${pv.startPage}" end="${pv.endPage}">
	 	...
	 	<c:param name="board_type" value="1" />
	 </c:url>
	 <c:choose>
	...
	<li class="page-item"><a class="page-link" href="reviewboard.do?currentPage=${pv.startPage+pv.blockPage}">Next</a></li>
	</c:if>
